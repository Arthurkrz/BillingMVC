...
namespace BillingMVC.Web.Models
{
    public class BillViewModel
    {
        ...
        [StringLength(100, MinimumLength = 3, ErrorMessage = "Nome da despesa não pode ter menos que 3 caracteres.")]
        [DisplayName("Nome")]
        ...
        [StringLength(100, MinimumLength = 2, ErrorMessage = "Origem da despesa não pode ter menos que 2 caracteres.")]
        [DisplayName("Origem")]
